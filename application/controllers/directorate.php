...
class Directorate extends CI_Controller {
    ...
    public function realisasi(){
		...
		$data['header'] = $this->load->view('shared/header','',TRUE);	
		$data['footer'] = $this->load->view('shared/footer','',TRUE);
		$data['content'] = $this->load->view('grafik/realisasi',array('header' => $dir_header, 'rlzn' => $realization, 'tgt' => $target_ws),TRUE);
    ...
    public function wallet(){
		...
		$data['header'] = $this->load->view('shared/header','',TRUE);	
		$data['footer'] = $this->load->view('shared/footer','',TRUE);
		$data['content'] = $this->load->view('grafik/wallet',array('header' => $dir_header,  'wlt_ws' => $wallet_ws, 'wlt_al' => $wallet_al, 'rlz_ws' => $realization),TRUE);
