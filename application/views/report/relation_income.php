...
<div id="" class="container no_pad">
	...
	<div>
		...
		Sedangkan 2014 sebesar Rp <?php echo number_format($rl_inc['inc_wal']['tot'],1)?> T. Share of Wallet BMRI <?php echo number_format($rl_inc['inc']['tot']/$rl_inc['inc_wal']['tot']*100,0)?>%
		</h4><br><br>
