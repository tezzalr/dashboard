				...
				<div style="width:100%; float:left; padding-right:20px;">
					...
					<table class="table table-bordered" style="font-size:10px;">
						<thead class="headertab"><tr>
							...
							<th>CASA XSell</th><th>(-) CASA</th><th>CASA to be</th><th>new SoW CASA</th>
						</tr></thead><tbody>
						<?php $i=1; $wlttot = 0; $castot = 0; $casa_tbtot = 0; $min_casatot = 0; $wltloantot = 0; $loantot = 0;
							...
							<tr>
								...
								<td style="background-color:#34aadc"><?php echo number_format($anchor['sow_loan'],0,'.',',')?> %</td>
							</tr>
						<?php
						 ...
						 <tr style="background-color:yellow; font-size:16px;">
							 ...
							 <td><?php echo number_format($castot/$wlttot/$loantot*$wltloantot,2,'.',',')?></td>
