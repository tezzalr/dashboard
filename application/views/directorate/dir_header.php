...
<div class="no_pad" style="border-bottom: 1px solid #ccc; margin-bottom: 20px;">
	...
	<ul class="nav nav-pills" style="float:right; margin-top:5px;">
		...
		<li><a href="<?php echo base_url()?>income/show/directorate/<?php echo $directorate?>">Income</a></li>
		<li><a href="<?php echo base_url()?>wallet/show/directorate/<?php echo $directorate?>">Wallet</a></li>
