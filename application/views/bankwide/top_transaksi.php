				...
				<div style="width:50%; float:left; padding-right:20px;">
					...
					<table class="table table-striped" style="font-size:10px;">
						<thead><tr>
							...
							<th>Target</th><th>Mei</th><th>YTD 2014</th><th>%</th>
						</tr></thead><tbody>
						<?php 
						...
						<?php
								...
								if(($temp_tot/$total_prd->$vol) > 0.7){break;}
						 	}?>
						 <tr>
				...
				<div style="width:50%;  float:left">
					...
					<table class="table table-striped" style="font-size:10px;">
						<thead><tr>
							...
							<th>Target</th><th>Mei</th><th>YTD 2014</th><th>Nominal Growth</th>
						</tr></thead><tbody>
						<?php 
							$vol = $product."_vol"; $temp_tot=0; $ly = $vol.'_ly'; $ly_tot=0; $nomgrowtot=0;
							$bagi=9; if($product == 'FX' || $product == 'Trade'){$bagi=6;}elseif($product == 'OIR'){$bagi=0;}
